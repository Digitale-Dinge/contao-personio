...
class PersonioRecruitingApi
{
    public static array $systemApplicationFields = [
        'job_position_id',
        'application_date',
    ];
    ...
    public function __construct(
        private readonly HttpClientInterface $personioRecruitingApiClient,
    ...
    public function request(string $method, string $url, array $options = []): ResponseInterface
    {
        ...
        try {
            $response = $this->personioRecruitingApiClient->request($method, $url, $options);
